...
CREATE TABLE IF NOT EXISTS `infra_document` (
  ...
  `parent_id` bigint NOT NULL DEFAULT '0' COMMENT '父文档编号',
  ...
  `type` tinyint NOT NULL DEFAULT '2' COMMENT '文档类型(1-文件夹, 2-文件)',
  ...
  KEY `idx_parent_id` (`parent_id`) USING BTREE COMMENT '父文档编号索引',
