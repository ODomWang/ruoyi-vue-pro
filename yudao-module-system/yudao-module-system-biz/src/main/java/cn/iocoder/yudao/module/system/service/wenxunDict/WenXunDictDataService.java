 ...
 * @author ruoyi
 */
public interface WenXunDictDataService {
     ...
     * @return 字典数据编号
     */
    Long createDictData(WenXunDictDataSaveReqVO createReqVO);
     ...
     */
    void updateDictData(WenXunDictDataSaveReqVO updateReqVO);
     ...
     * @return 字典数据全列表
     */
    List<WenXunDictDataDO> getDictDataList(@Nullable Integer status, @Nullable String dictType);
     ...
     * @return 字典数据分页列表
     */
    PageResult<WenXunDictDataDO> getDictDataPage(WenXunDictDataPageReqVO pageReqVO);
     ...
     * @return 字典数据
     */
    WenXunDictDataDO getDictData(Long id);
     ...
     * @return 字典数据
     */
    WenXunDictDataDO getDictData(String dictType, String value);
     ...
     * @return 字典数据
     */
    WenXunDictDataDO parseDictData(String dictType, String label);
