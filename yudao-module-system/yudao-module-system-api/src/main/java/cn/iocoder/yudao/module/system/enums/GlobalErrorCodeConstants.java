...
public interface GlobalErrorCodeConstants {
    ...
    ErrorCode  URL_PING_INFO_NOT_EXISTS= new ErrorCode(2_002_007_001, "记录不存在");
    ErrorCode  URL_PING_LOG_NOT_EXISTS= new ErrorCode(2_002_007_001, "记录不存在");
    ErrorCode  URL_CHANGE_LOG_NOT_EXISTS= new ErrorCode(2_002_007_001, "记录不存在");
    ErrorCode URL_CHANGE_INFO_NOT_EXISTS= new ErrorCode(2_002_007_001, "记录不存在");
}