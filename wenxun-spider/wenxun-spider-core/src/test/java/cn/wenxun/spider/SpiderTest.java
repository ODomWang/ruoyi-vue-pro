...
public class SpiderTest implements PageProcessor {
    //.getSite().setUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36")
    ...
    public void process(Page page) {
        ...
        List<String> url = page.getHtml().links().regex("(https://www\\.bzpt\\.edu\\.cn/(info|xwdr/xyyw).*)").all();
    ...
    public static void main(String[] args) {
        Spider.create(new SpiderTest()).addUrl("https://www.bzpt.edu.cn/xwdr/xyyw.htm").thread(1).run();
    }
}