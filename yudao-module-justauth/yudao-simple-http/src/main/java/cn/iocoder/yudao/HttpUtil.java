...
import cn.iocoder.yudao.config.HttpConfig;
import cn.iocoder.yudao.constants.Constants;
import cn.iocoder.yudao.exception.SimpleHttpException;
import cn.iocoder.yudao.support.AbstractHttp;
import cn.iocoder.yudao.support.Http;
...
import cn.iocoder.yudao.support.okhttp3.OkHttp3Impl;
import cn.iocoder.yudao.util.ClassUtil;
import cn.iocoder.yudao.support.httpclient.HttpClientImpl;
...
public class HttpUtil {
    ...
    private void selectHttpProxy() {
        ...
        if (null == defaultProxy && ClassUtil.isPresent("java.net.http.HttpClient", classLoader)) {
            defaultProxy = getHttpProxy(cn.iocoder.yudao.support.java11.HttpClientImpl.class);
        }
