...
import cn.iocoder.yudao.module.wenxun.dal.mysql.auditlog.AuditLogMapper;
    ...
    public void updateAuditLog(AuditLogSaveReqVO updateReqVO) {
        ...
        if (updateObj.getStatus() == 1) {
            ...
            if (infoDO != null) {
                ...
                CustomerAuditLogDO customerAuditLogDO = customerAuditLogMapper.selectOne(CustomerAuditLogDO::getSpiderId, vo.getSpiderConfigId());
